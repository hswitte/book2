...
## For a state X, what is the distribution of ratings for establishments with at least Y reviews?

<div style="border:1px grey solid; padding:5px;">
    <div><h5>State: X</h5>
        <input id="arg1" type="text" value="PA"/>
    </div>
    <div><h5>Review Count: Y</h5>
        <input id="arg2" type="text" value="10"/>
    </div>
    <div><h5>Sort</h5>
...
function viz(arg1, arg2, arg3){    
    ...
    var state = _.filter(items, function(d){
        return (d.state == arg1 && d.review_count >= arg2)
        })
